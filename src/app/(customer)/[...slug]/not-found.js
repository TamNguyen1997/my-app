  ...
  return (<section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-sm text-center">
        ...
        <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Không tìm thấy sản phẩm bạn đang tìm. Vui lòng liên hệ với nhân viên bán hàng để biết thêm thông tin</p>
