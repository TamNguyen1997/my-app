...

                                {
                                    isVATActive && <div className="space-y-2 !mt-3 !mb-6">
                                        <Input
                                            ...
                                            {...register("businessName", { required: isVATActive })}
                                            isRequired={isVATActive}
                                        />
                                        {errors.businessName && <span className="text-red-600 text-small">Bạn phải điền tên Công ty</span>}
                                        <Input
                                            label="Mã số thuế"
                                            aria-label="Mã số thuế"
                                            {...register("businessCode", { required: isVATActive })}
                                            isRequired={isVATActive}
                                        />
                                        {errors.businessCode && <span className="text-red-600 text-small">Bạn phải điền mã số thuế</span>}
                                        <Input
                                            ...
                                            isRequired
                                        />
                                        {errors.businessEmail && <span className="text-red-600 text-small">Bạn phải điền email nhận hóa đơn</span>}
                                    </div>
                                }
                            </div>
