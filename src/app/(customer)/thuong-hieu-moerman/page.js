...
export default async function Page({ searchParams }) {
  ...
  return (
    <>
      ...
      />
      <BrandPage brand="thuong-hieu-moerman" bg="bg-[url(/brand/banner/1440_290_Banner_Cate_Moerman.png)]" filters={filters} products={products} defaultOrderBy={orderBy?.join(":")} defaultRange={range?.split('-').map(Number) || [0, 100000000]} defaultFilterIds={filterIds} />
    </>
  )
}
