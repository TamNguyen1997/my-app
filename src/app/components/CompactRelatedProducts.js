...
const CompactRelatedProducts = ({ relatedProducts = [] }) => {
  ...
  return (<>
    <div className="relative">
      ...
      >
        {
          relatedProducts.map((product, i) => <ProductCard product={product} key={i} compact={true} />)
        }
      </Carousel>
    </div>
  </>)
...
export default CompactRelatedProducts
