...
const Introduction = () => {
  return (
    <div className="bg-introduction bg-center w-full bg-cover bg-no-repeat mb-8 md:h-[700px] sm:h-[600px]" style={{
      ...
      <div className="flex gap-7 max-w-[1200px] px-4 mx-auto w-full flex-col pt-[120px]">
        ...
        <div className="flex gap-4 flex-wrap">
          <img src="/brand/Logo-Ghibli.png" alt="Ghibli" width={150} height={60}></img>
          <img src="/brand/Rubbermaid.png" alt="Rubbermaid" width={150} height={60}></img>
          <img src="/brand/Logo-Kimberly-Clark.png" alt="Kimberly" width={150} height={60}></img>
          <img src="/brand/Logo-Moerman.png" alt="Moerman" width={150} height={60}></img>
          <img src="/brand/KLEEN-TEX.png" alt="KLEEN-TEX" width={150} height={60}></img>
          <img src="/brand/Logo-Mapa.png" alt="MAPA" width={150} height={60}></img>
        </div>
        <div className="text-xl font-medium text-justify w-2/3">
