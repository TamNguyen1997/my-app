...
const TechnicalDetailForm = () => {
  ...
  const addEmptyTechnicalDetail = () => {
    setSelectedProduct(
      Object.assign(
        {},
        selectedProduct,
        { technicalDetails: [...selectedProduct.technicalDetails, { id: v4(), productId: selectedProduct.id }] }
      ))
  }
  ...
  return (
    <>
      <div>
        <Button color="default" variant="ghost" size="sm" className="float-right" onPress={addEmptyTechnicalDetail}> <Plus></Plus> </Button>
      </div>
      <div>
        {
