const getPrice = (product) => {
  ...
  if (product.saleDetails.length === 1) return product.saleDetails[0].price

  if (!product.saleDetails[0].price) return product.saleDetails[product.saleDetails.length - 1].price
